...
![typeError](https://raw.githubusercontent.com/adeleke5140/portfolio-v2/main/public/images/pluckV3error.png)
...
Typescript offers us a lot quality of life improvement. So while it can be tempting to use `any`` all over the place, precise types benefits far outweighs the trouble of thinking a bit more about our type system.
