    ...
    <footer className="absolute bottom-0">
      ...
      >
        ...
        <ul className="flex gap-4">
          <li>
            <a
              className="text-link-color font-extrabold hover:opacity-100 origin-left transition-transform-opacity ease-out duration-200 hover:scale-110 hover:translate-x-1 hover:-translate-y-0.5 focus:outline-none rounded focus:ring focus:ring-heading-color"
              rel="external"
