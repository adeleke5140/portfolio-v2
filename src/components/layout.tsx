...
function getBorderRadius(path: string) {
  if (path == '/') {
    return {
      borderRadius: '16px',
...
const Layout = ({ children }: LayoutProps) => {
  ...
  return (
    <>
      ...
      <div className="flex relative min-h-screen flex-col bg-ken-pattern">
        <svg width="100%" height="24px" xmlns="http://www.w3.org/2000/svg">
          <defs>
            <pattern
              id="pattern-75"
        ...
        <main className="pt-8 mx-auto max-w-xl  md:pt-12 place-items-center w-full'">
          {children}
        </main>
