...
export const BatteryWidget = () => {
  ...
  return (
    <div className="bg-white px-6 border border-dashed w-80 py-8 flex flex-col gap-4">
      <button
        onClick={() => setPercentage(69)}
        className="absolute bg-white rounded-md size-4 grid place-items-center top-2 right-2"
      >
      ...
      <div className="inline-flex items-center gap-2">
        <svg width="18" height="18" viewBox="0 0 18 18">
          <g>
            ...
            ></path>
            <path
              d="M7.5,6.5c-.414,0-.75,.336-.75,.75v3.5c0,.414,.336,.75,.75,.75s.75-.336,.75-.75v-3.5c0-.414-.336-.75-.75-.75Z"
              fill="#525252"
            ></path>
            <path
              d="M10.25,6.5c-.414,0-.75,.336-.75,.75v3.5c0,.414,.336,.75,.75,.75s.75-.336,.75-.75v-3.5c0-.414-.336-.75-.75-.75Z"
              fill="#525252"
            ></path>
        ...
        <span>
          96% <span className="">battery health</span>
        </span>
      </div>
      <div className="inline-flex items-center gap-2">
        <svg width="20" height="20" viewBox="0 0 20 20">
          <g fill="#212121">
            <path
              d="m10,6h-4c-1.657,0-3,1.343-3,3v2c0,1.657,1.343,3,3,3"
              fill="none"
              stroke="#525252"
            ...
            ></path>
            <path
              d="m10,14h4c1.657,0,3-1.343,3-3v-2c0-1.657-1.343-3-3-3"
              fill="none"
              stroke="#525252"
              stroke-linecap="round"
              stroke-linejoin="round"
            ...
            ></path>
            <polyline
              points="12.75 11.25 10 14 12.75 16.75"
              fill="none"
              stroke="#525252"
              stroke-linecap="round"
              stroke-linejoin="round"
            ...
            ></polyline>
            <polyline
              points="7.25 8.75 10 6 7.25 3.25"
              fill="none"
              stroke="#525252"
              stroke-linecap="round"
              stroke-linejoin="round"
        ...
        <span>
          215 <span className="text-ken-grey">cycles</span>
        </span>
      </div>
      <div className="flex relative mt-6  gap-2 overflow-hidden w-full">
        ...
        {Array.from({ length: 6 }).map((_, index) => (
          <span
            key={index}
            className="h-1 after:z-30 relative after:absolue after:content-[''] after:h-full after:top-0 after:absolute after:inline-block after:w-[8px] after:bg-white after:right-full inline-block w-20 bg-gray-300/50"
          />
        ))}
      </div>
      <div
        className={cn(
          'absolute transition-transform duration-400 ease-[cubic-bezier(0.19,1,0.22,1)] bottom-2 text-xs right-2 bg-white shadow-sm px-2 rounded-md py-1',
          showN ? 'translate-y-0' : 'translate-y-[150%]'
        )}
      >
        <button
          onClick={() => setShowN(false)}
          className="bg-gray-100 border border-dashed grid place-items-center rounded-full size-3 absolute -top-1 -right-1"
        >
